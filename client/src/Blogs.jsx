...
export default function Blogs() {
    ...
    const [isViewBlogOpen, setIsViewBlogOpen] = useState({isOpen: false, title: '', body: '', user: ''})
    ...
    function BlogComponent({title, body, user}) {
        return (
            <div className="blog-component">
                ...
                <div className="blog-component-right">
                    {user == username ?
                        <>
                            <button className="fw-500 m-2 btn-blue" onClick={() => {setIsViewBlogOpen({isOpen: true, title: title, body: body, user:user})}}>View</button>
            ...
            <div className="blogs-content">                
                <div className="blog-post">
                    ...
                    <div className="blog-post-right">
                        ...
                        }
                        {
                            ...
                            <div className="blog-view-modal" onClick={() => {setIsViewBlogOpen({isOpen: false, title: '', body: '', user: ''})}}>
                                <div className="blog-view-modal-content" onClick={(e) => {e.stopPropagation()}}>
                                    ...
                                    <button className="m-2 btn-red"  onClick={() => {setIsViewBlogOpen({isOpen: false, title: '', body: '', user: ''})}}>Close</button>
                                </div>
                ...
                <div className="all-blogs">
                    ...
                    <div className="all-blogs-content">
                        {
                            allBlogs.map(blog => {
                                return <BlogComponent title={blog.title} body={blog.body} user={blog.user}/>
                            })
                        }
                    </div>
                </div>
