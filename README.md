This is a project made with REACT.js and Express.js with MongoDB as the database. It features user authentication with JWT, server-side validation and overall display of skills of frontend and backend. 
